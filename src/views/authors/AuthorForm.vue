    ...
    <div class="author-form">
        ...
        <el-form ref="form" :rules="rules" :model="form" label-width="100px">
            ...
            <el-form-item label="Year of birth" prop="born_at">
                <el-input-number v-model="form.born_at" :max="2010"></el-input-number>
            </el-form-item>

            <el-form-item label="Year of death" prop="died_at">
                <el-input-number v-model="form.died_at"></el-input-number>
            </el-form-item>

            <el-form-item label="Country" prop="country">
                <el-input v-model="form.country" placeholder="Paraguay"></el-input>
            </el-form-item>
