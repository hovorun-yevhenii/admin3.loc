    ...
    <div class="user-form">
        ...
        <el-form ref="form" :rules="rules" :model="form" label-width="80px">
            ...
            <el-form-item label="Role" prop="role">
                <el-select v-model="form.role" placeholder="please select user's role" value="Reader">
            ...
            <el-form-item label="Password" prop="password">
                <el-input type="password" v-model="form.password" placeholder="five or more symbols"></el-input>
            </el-form-item>

            <el-form-item label="Phone" prop="phone">
                <el-input v-model="form.phone" v-mask="'+# (###) ###-####'" placeholder="+1 (111) 111-1111"></el-input>
            </el-form-item>
